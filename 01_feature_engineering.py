...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=1444828305810485&notebook=%2F01-mlops-quickstart%2F01_feature_engineering&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F01-mlops-quickstart%2F01_feature_engineering&version=1">
...
# MAGIC %md
# MAGIC LAB: 
# MAGIC 1. Press Alt and click at the same time in the next cell on ../_resources/00-setup
# MAGIC 2. Fill the catalog and schema 
# MAGIC 3. Come back to this notebook and launch the next cell
...
# DBTITLE 1,is it necessary?
# MAGIC %sql
# MAGIC SELECT * FROM christophe_chieu.mlops_end2end.mlops_churn_bronze_customers

# COMMAND ----------

telco_df = spark.read.table("christophe_chieu.mlops_end2end.mlops_churn_bronze_customers").pandas_api()
...
# Read into Spark
telcoDF = spark.read.table("christophe_chieu.mlops_end2end.mlops_churn_bronze_customers")
display(telcoDF)
...
(churn_features.write.mode("overwrite")
               ...
               .saveAsTable("christophe_chieu.mlops_end2end.mlops_churn_training"))
...
# MAGIC %md
# MAGIC #### LAB: Using AutoML with labelled feature tables
# MAGIC
...
# MAGIC
# MAGIC Use this [document](https://docs.databricks.com/en/machine-learning/automl/automl-api-reference.html#classify) to fill the empty values in the next cell.
...
automl_run = automl.classify(
    experiment_name = #TO FILL,
    experiment_dir = #TO FILL,
    dataset = #TO FILL,
    target_col = #TO FILL,
    split_col = #TO FILL, 
    timeout_minutes = #TO FILL,
    exclude_cols = #TO FILL
)
