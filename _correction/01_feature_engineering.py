...
catalog = "christophe_chieu"
db = "mlops_end2end"

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE christophe_chieu.mlops_end2end.mlops_churn_bronze_customers CLONE mlops_churn_bronze_customers
...
# MAGIC %md
# MAGIC #### Correction LAB: Using AutoML with labelled feature tables
# MAGIC
