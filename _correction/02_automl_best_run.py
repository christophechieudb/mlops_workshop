...
# MAGIC %pip install --quiet databricks-sdk==0.23.0 mlflow==2.14.0 databricks-automl-runtime holidays category-encoders lightgbm hyperopt
...
# MAGIC %md
# MAGIC ### Correction LAB: numerical columns
# MAGIC
